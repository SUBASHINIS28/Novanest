...
import ExpertiseTag from './common/ExpertiseTag';

const Profile = ({ expertiseAreas, onUpdateExpertise, showNotification }) => {
  ...
  return (
    <>
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">Manage your profile information and expertise areas.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {isEditing ? (
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                <div className="flex justify-center mb-6">
                  <div className="relative">
                    <div className="h-28 w-28 rounded-full p-1 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 shadow-xl">
                ...
                <div className="mt-5">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                    placeholder="Share your background, interests, and what you're working on..."
                  ></textarea>
                  <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Brief bio that helps mentors understand your background</p>
                </div>
                ...
                <div className="mt-5 flex justify-end space-x-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex items-center"
                    disabled={saving}
                  >
                    {saving ? (
                      <>
              ...
              <div className="p-6">
                <div className="flex flex-col items-center md:flex-row md:items-start mb-8">
                  <div className="w-28 h-28 rounded-full p-1 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 shadow-xl mb-4 md:mb-0 md:mr-6">
                    <div className="rounded-full w-full h-full overflow-hidden border-2 border-white dark:border-gray-800">
                      <img
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      {user?.profileDetails?.title && user?.profileDetails?.company ? 
                        ...
                        user?.profileDetails?.title || user?.profileDetails?.company || 'Entrepreneur'
                      }
                    </p>
        ...
        <div className="lg:col-span-1">
          ...
          >
            <div className="border-b border-gray-100 dark:border-gray-700 px-6 py-4 flex justify-between items-center">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Areas of Interest</h3>
              <button 
                onClick={() => onUpdateExpertise && onUpdateExpertise()}
                className="inline-block px-1.5 py-0.5 text-xs font-medium rounded bg-amber-50 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-800/40 transition-colors w-auto border border-amber-100 dark:border-amber-800/50"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-0.5 inline-block" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="p-6">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Select topics you're interested in to receive better mentor matches.
              </p>
              
              <div className="flex flex-wrap gap-2">
                {expertiseAreas && expertiseAreas.length > 0 ? (
                  expertiseAreas.map((area) => (
                    <ExpertiseTag key={area} name={area} />
                  ))
                ) : (
                  <p className="text-gray-500 dark:text-gray-400 text-sm italic">
                    No interests added yet. Click 'Manage' to add some.
                  </p>
                )}
              </div>
            </div>
          ...
          >
            ...
            <div className="p-6 text-center">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">See how your profile appears to mentors</p>
              <Link 
                to={`/entrepreneur/${user?._id}`}
                target="_blank"
                rel="noopener noreferrer"
