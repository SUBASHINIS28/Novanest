            ...
            <div className="p-4">
              {activeMentorships.filter(m => m.nextSession).length > 0 ? (
                ...
                <div className="text-center py-6">
                  ...
                  <button className="mt-2 inline-flex items-center px-3 py-1.5 border border-gray-300 text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
              ...
              {availabilitySlots.length > 0 ? (
                    ...
                    <div key={idx} className="py-3 flex justify-between items-center">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button 
                          ...
                          className="inline-flex items-center p-1 border border-gray-300 rounded-md text-red-500 hover:bg-red-50"
                          title="Delete slot"
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="text-center py-6">
                  ...
                  <button 
                    ...
                    className="mt-2 inline-flex items-center px-3 py-1.5 border border-gray-300 text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none"
                  >
                    ...
                    <div className="space-y-2">
                      {Object.keys(officeHoursSettings.weeklyAvailability).map(day => (
                        <div key={day} className="flex items-center justify-between">
                          ...
                          <div className="flex space-x-2">
                            <select 
                              className="block w-24 pl-2 pr-6 py-1 text-sm border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 rounded-md"
